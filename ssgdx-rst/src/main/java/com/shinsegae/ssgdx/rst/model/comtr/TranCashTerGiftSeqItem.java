...
@Getter
@Setter
public class TranCashTerGiftSeqItem {
    ...
    private List<TCTGSIRecordList> RecordList = new ArrayList<TCTGSIRecordList>(); // RecordList
                                                                                   // 반복

    @Getter
    @Setter
    private static class TCTGSIRecordList {
        ...
        private String GiftType; // 계수기,봉투
    }
}
