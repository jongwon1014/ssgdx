...
@Getter
@Setter
public class TranCashTerCashrecvItem {
    ...
    private String BagCheckInNonDenoCnt; // 비정액 수표 매수

    @IIrtFldMeta(size = 11)
    @JsonProperty("BagCheckInNonDenoAmt")
    private String BagCheckInNonDenoAmt; // 비정액 수표 금액
    ...
    private String AllianceGiftAmt; // 제휴 상품권 금액
    ...
    private String CoinOutCnt500; // 500원권 주화 매수

    @IIrtFldMeta(size = 5)
    @JsonProperty("CoinOutCnt100")
    private String CoinOutCnt100; // 100원권 주화 매수

    @IIrtFldMeta(size = 5)
    @JsonProperty("CoinOutCnt50")
    private String CoinOutCnt50; // 50원권 주화 매수

    @IIrtFldMeta(size = 5)
    @JsonProperty("CoinOutCnt10")
    private String CoinOutCnt10; // 10원권 주화 매수
