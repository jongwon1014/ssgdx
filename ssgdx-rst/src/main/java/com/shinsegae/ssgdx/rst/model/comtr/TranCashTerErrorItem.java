...
@Getter
@Setter
public class TranCashTerErrorItem {
    ...
    @JsonProperty("DeviceItem")
    @IIrtFldMeta(dType = EnmTranFieldType.LIST)
    private List<TCTEIDeviceItem> DeviceItem = new ArrayList<TCTEIDeviceItem>(); // DeviceItem
                                                                                 // 반복구간

    @Getter
    @Setter
    private static class TCTEIDeviceItem {
