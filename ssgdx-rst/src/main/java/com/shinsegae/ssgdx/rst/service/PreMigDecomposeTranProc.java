 ...
 * @fileName : PreMigDecomposeTranProc.java
 * @author : q93m9k
 * @date : 2024.03.08
 * @description :
 * 
...
@Getter
@Setter
public class PreMigDecomposeTranProc {

    private final IdGeneratorFactory idGeneratorFactory;

    private SqlSession sqlSession;

    private PreMigQueryProc queryProc;
    ...
    public PreMigDecomposeTranProc(IdGeneratorFactory idGeneratorFactory, SqlSession sqlSession, byte[] tranDataOBytes)
                ...
                if(tranType != null && ("02".equals(tranType) || "11".equals(tranType) || "12".equals(tranType))){
                    ...
                    if("02".equals(tranType)){
                        ...
                        if(cmmnCdRfrValAsIs != null){
                            ...
                            nDebugFlag = 3;
                            cmmnCdRfrValToBe = queryProc.selectDepositItemCmmnCdRfrVal(sqlSession, paramMap, sTranInfo,
                                    logParamMap);
                            nDebugFlag = 0;
                        ...
                        nDebugFlag = 3;
                        shopCode = queryProc.selectDepositItemShopCode(sqlSession, paramMap, sTranInfo, logParamMap);
                        nDebugFlag = 0;
    ...
    public int parseTranGoodsItem(int itemLength, String sTranInfo, int nGoodsItemItemSeq){
        ...
        try{
            ...
            nDebugFlag = 3;
            tranGoodsItemN.setCategoryCode(
                    queryProc.selectGoodsItemCategoryCode(sqlSession, paramMap, sTranInfo, logParamMap));
            nDebugFlag = 0;
            ...
            paramMap.put("mdCode", tranGoodsItemO.getMdCode());
            nDebugFlag = 3;
            Map<String, String> retMap = queryProc.selectGoodsItemShopCdBizRelmCd(sqlSession, paramMap, sTranInfo,
                    logParamMap);
            ...
            paramMap.put("mdCode", tranGoodsItemO.getMdCode());
            nDebugFlag = 3;
            tranGoodsItemN.setProfitCenterCode(
                    ParseHelper.getRpadFillSpaceStringForNewTran(tranGoodsItemN, "ProfitCenterCode",
                            queryProc.selectGoodsItemProfitCenterCode(sqlSession, paramMap, sTranInfo, logParamMap)));
            nDebugFlag = 0;
            ...
            if(pluType != null){
                ...
                if("2".equals(pluType)){
                    nDebugFlag = 3;
                    prdtBrandCode = queryProc.selectGoodsItemPrdtBrandCode(sqlSession, paramMap, sTranInfo,
                            logParamMap);
                    nDebugFlag = 0;
                }
            }
            ...
            if(pluType != null){
                ...
                if("2".equals(pluType)){
                    ...
                    nDebugFlag = 3;
                    eventApplyCode = queryProc.selectGoodsItemEvnCd(sqlSession, paramMap, sTranInfo, logParamMap);
                    nDebugFlag = 0;
                }
            }
            ...
            nDebugFlag = 3;
            String evnId = queryProc.selectGoodsItemEventMngYMEventMngNo(sqlSession, paramMap, sTranInfo, logParamMap);
    ...
    public int parseTranCCFreeSetItem(int itemLength, String sTranInfo){
        ...
        try{
            ...
            nDebugFlag = 3;
            tranCCFreeSetItemN
                    .setShopCode(queryProc.selectCCFreeSetItemShopCode(sqlSession, paramMap, sTranInfo, logParamMap));
            nDebugFlag = 0;
    ...
    public int parseTranCashTerAmtItem_DX(int itemLength, String sTranInfo){
        ...
        try{
            ...
            nDebugFlag = 3;
            tranCashTerAmtItemDXN.setShopCd(
                    queryProc.selectTranCashTerAmtItemDXShopCd(sqlSession, paramMap, sTranInfo, logParamMap));
            nDebugFlag = 0;
            ...
            for(TranDmsItemO.DmsItemList_O dmsItemListO : tranDmsItemO.getDmsItemList()){
                ...
                // 쿠폰행사인 경우
                    ...
                    if("999912".equals(dmsItemListN.getYM())){
                        ...
                        nDebugFlag = 3;
                        sCP_CD_TG = queryProc.selectDmsItemCpCd(sqlSession, paramMap, sTranInfo, logParamMap);
                        nDebugFlag = 0;
                    }
                }else{
                    sCP_CD_TG = "";
                ...
                if(cpIssNo != null && cpIssNo.length() > 0){
                    if("999912".equals(dmsItemListN.getYM())){
                        ...
                        nDebugFlag = 3;
                        retMap = queryProc.selectDmsItemcpIssNo(sqlSession, paramMap, sTranInfo, logParamMap);
                        nDebugFlag = 0;
                ...
                if(dmsItemListN.getEVT_KIND_CD() != null && ("11".equals(dmsItemListN.getEVT_KIND_CD().trim())
                    ...
                    nDebugFlag = 3;
                    cpCaclValidDate = queryProc.selectDmsItemcpCaclValidDate(sqlSession, paramMap, sTranInfo,
                            logParamMap);
                    nDebugFlag = 0;
        ...
        try{
            ...
            for(TranCardIcItemO.TranCardIcItemOItemList oItem : tranCardIcItemO.getItemList()){
                ...
                nItem.setCode(ParseHelper.getLpadFillSpaceStringForNewTran(nItem, "Code",
                        queryProc.selectTranCardIcItemItemListCode(sqlSession, paramMap, sTranInfo, logParamMap)));

                // 사업영역코드
                nItem.setBIZ_RELM_CD(ParseHelper.getLpadFillSpaceStringForNewTran(nItem, "BIZ_RELM_CD",
                        queryProc.selectTranCardIcItemItemListBizRelmCd(sqlSession, paramMap, sTranInfo, logParamMap)));
    ...
    public int parseTranKakaopayItem(int itemLength){
        ...
        try{
            ...
            tranKakaopayItem_N.setBizRelmCd(ParseHelper.getLpadFillSpaceStringForNewTran(tranKakaopayItem_N,
                    "BizRelmCd", tranKakaopayItem_O.getFiller().substring(0, 1 + 4)));
    ...
    public int parseTranEasyPaymentItem(int itemLength){
        ...
        try{
            ...
            tranEasyPaymentItem_N.setBIZ_RELM_CD(ParseHelper.getLpadFillSpaceStringForNewTran(tranEasyPaymentItem_N,
                    "BIZ_RELM_CD", tranEasyPaymentItem_O.getFILLER().substring(0, 1 + 4)));
    ...
    public int parseTranShinBaekMoneyItem(int itemLength){
        ...
        try{
            ...
            tranShinBaekMoneyItem_N.setBIZ_RELM_CD(ParseHelper.getLpadFillSpaceStringForNewTran(tranShinBaekMoneyItem_N,
                    "BIZ_RELM_CD", tranShinBaekMoneyItem_O.getDATA_ETC_FIELD().substring(0, 1 + 4)));
    ...
    public int parseTranPaycoinItem(int itemLength){
        ...
        try{
            ...
            // sTranInfo, logParamMap));
            tranPaycoinItemN.setBIZ_RELM_CD(
                    ParseHelper.getLpadFillSpaceStringForNewTran(tranPaycoinItemN, "setBIZ_RELM_CD", ""));
            nDebugFlag = 0;
