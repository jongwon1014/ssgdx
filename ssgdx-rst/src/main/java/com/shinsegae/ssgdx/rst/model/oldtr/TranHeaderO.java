...
public class TranHeaderO {
    ...
    private String ParkingFlag; // 주차Flag 및 전자지값 Flag
    ...
    private String ChicorEnuri_Yn; // 시코르 에누리 적용 여부

    @IIrtFldMeta(size = 1)
    @JsonProperty("SmpEnuri_Yn")
    private String SmpEnuri_Yn; // 스마일페이 할인 여부
