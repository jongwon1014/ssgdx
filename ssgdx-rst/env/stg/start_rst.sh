...
# DB
export MDS_USER=dept-sm-an2-op-stg-opmds
export MDS_MASTER_URL=jdbc-secretsmanager:log4jdbc:mysql:aws://dept-rds-an2-op-stg-opmdsdbt.cluster-ckcic5dtfarb.ap-northeast-2.rds.amazonaws.com:3306/MDSSTG
export MDS_READER_URL=jdbc-secretsmanager:log4jdbc:mysql:aws://dept-rds-an2-op-stg-opmdsdbt.cluster-ro-ckcic5dtfarb.ap-northeast-2.rds.amazonaws.com:3306/MDSSTG
export SLC_USER=dept-sm-an2-op-stg-opslc
export SLC_MASTER_URL=jdbc-secretsmanager:log4jdbc:mysql:aws://dept-rds-an2-op-stg-opslcdbt.cluster-ckcic5dtfarb.ap-northeast-2.rds.amazonaws.com:3306/SLCSTG
export SLC_READER_URL=jdbc-secretsmanager:log4jdbc:mysql:aws://dept-rds-an2-op-stg-opslcdbt.cluster-ro-ckcic5dtfarb.ap-northeast-2.rds.amazonaws.com:3306/SLCSTG
export DMS_USER=dept-sm-an2-op-stg-opdms
export DMS_MASTER_URL=jdbc-secretsmanager:log4jdbc:mysql:aws://dept-rds-an2-op-stg-opdmsdbt.cluster-ckcic5dtfarb.ap-northeast-2.rds.amazonaws.com:3306/DMSSTG
export DMS_READER_URL=jdbc-secretsmanager:log4jdbc:mysql:aws://dept-rds-an2-op-stg-opdmsdbt.cluster-ro-ckcic5dtfarb.ap-northeast-2.rds.amazonaws.com:3306/DMSSTG
...
# Redis
export REDIS_URL=dept-ecc-an2-cm-stg-redis.eojlre.clustercfg.apn2.cache.amazonaws.com:6379
# Secrets Manager
...
nohup java -javaagent:/sorc001/dd-java-agent.jar \
  ...
  -jar -Dspring.profiles.active=stg /sorc001/ssgdx-rst.jar  > /dev/null 2>&1 &
